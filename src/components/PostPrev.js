        ...
        return (
            ...
            <div className="postContainer" key={node.slug}>
                ...
                {node.content.includes("<!--more-->") ?
                    <div id="content"
                         dangerouslySetInnerHTML={{__html: node.content.split("<!--more-->")[0].replace(/http:\/\/backend\.hesamkaveh\.com\/wp-content\/uploads/g, 'https://backend.hesamkaveh.com/wp-content/uploads')}}/> :
                    <div id="content"
